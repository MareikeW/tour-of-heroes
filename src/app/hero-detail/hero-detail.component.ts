...
/* Child component to ParentComponent HeroesComponent */
...
export class HeroDetailComponent implements OnInit {
  ...
  // @Input() decorator, because the external HeroesComponent will bind to it like this.
  @Input() hero?: Hero;

  /* The ActivatedRoute holds information about the route to this instance of the HeroDetailComponent. 
  This component is interested in the route's parameters extracted from the URL. The "id" parameter is 
  the id of the hero to display.

  The HeroService gets hero data from the remote server and this component will use it to get the 
  hero-to-display.
